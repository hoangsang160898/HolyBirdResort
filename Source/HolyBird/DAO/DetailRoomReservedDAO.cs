...
namespace DAO
{
    public class DetailRoomReservedDAO
    {
        ...
        {
            string sTruyVan = @"Select GD.MaDoan, KH.HoTen, KH.CMND, CTGD.ID_Phong, format(CTGD.NgayBatDau,'MM/dd/yyyy') as NgayBatDau, format(CTGD.NgayKetThuc,'MM/dd/yyyy') as NgayKetThuc, P.Gia, CTGD.ThanhTien
